 ...
 */
/* FIXME: move function specific flags to duk_hcompiledfunction only; they
 * then don't overlap with duk_harray. CHeck call sites.
 */
...
#define DUK_HOBJECT_CLASS_BUFFER               16  /* custom; implies DUK_HOBJECT_IS_BUFOBJ */
